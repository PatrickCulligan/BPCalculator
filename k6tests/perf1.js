...
export default function () {
    let res = http.get("import { check, sleep } from "k6";
import http from "k6/http";
...
export default function () {
    let res = http.get("https://yourwebsite.comhttps://bpcalulator-green-slot-dscydwgqh3eyfxf4.ukwest-01.azurewebsites.net/");
  check(res, {
